...
if __name__ == '__main__':
    ...
    model = Sequential()
    model.add(Conv1D(filters = 32, kernel_size = 2, strides = 1, padding = 'valid', input_shape = (29, 1)))
#    model.add(Conv1D(filters = 32, kernel_size = 2, strides = 1, padding = 'valid'))
    ...
    model.fit(X_train, Y_train, batch_size=50, epochs=30, verbose=2,  validation_data=(X_test, Y_test), callbacks=[checkpointer])
